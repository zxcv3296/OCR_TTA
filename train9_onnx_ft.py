...
def train(opt):
    ...
    train_dataset, _ = hierarchical_dataset(root=opt.train_data, opt=opt)
    ...
    iteration = 0
    for epocn in range(10000):
        for it, (image_tensors, raw_labels_batch) in enumerate(train_loader):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--valInterval',   type=int, default=5, help='validation interval')
